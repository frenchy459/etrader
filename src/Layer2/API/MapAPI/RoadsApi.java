...
import Layer2.API.MapAPI.errors.ApiError;
...
import Layer2.API.MapAPI.model.SnappedPoint;
import Layer2.API.MapAPI.model.SnappedSpeedLimitResponse;
import Layer2.API.MapAPI.model.SpeedLimit;
...
public class RoadsApi {
   ...
   *     #snapToRoads(GeoApiContext, Layer2.API.MapAPI.model.LatLng...)} method. You can pass up to
