...
import Layer3.Controllers.Register;
...
{
    private static final String API_KEY = "AIzaSyAbUgjaY2LjckSSljG6lZUHxJM98GHygN8";
    ...
    {
        GeoApiContext geoApiContext = new GeoApiContext.Builder().apiKey("AIzaSyAbUgjaY2LjckSSljG6lZUHxJM98GHygN8").queryRateLimit(200).build();
