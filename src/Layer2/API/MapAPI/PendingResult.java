...
public interface PendingResult<T> {
   ...
   * Layer2.API.MapAPI.PendingResult.Callback#onResult onResult} or {@link
   * Layer2.API.MapAPI.PendingResult.Callback#onFailure onFailure} after the request has been
   * completed.
   *
