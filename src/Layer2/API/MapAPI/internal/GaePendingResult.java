...
package Layer2.API.MapAPI.internal;
...
import Layer2.API.MapAPI.GeolocationApi;
import Layer2.API.MapAPI.ImageResult;
import Layer2.API.MapAPI.PendingResult;
import Layer2.API.MapAPI.errors.ApiException;
import Layer2.API.MapAPI.errors.UnknownErrorException;
import Layer2.API.MapAPI.model.AddressComponentType;
import Layer2.API.MapAPI.model.AddressType;
import Layer2.API.MapAPI.model.Distance;
import Layer2.API.MapAPI.model.Duration;
import Layer2.API.MapAPI.model.EncodedPolyline;
import Layer2.API.MapAPI.model.Fare;
import Layer2.API.MapAPI.model.LatLng;
import Layer2.API.MapAPI.model.LocationType;
import Layer2.API.MapAPI.model.OpeningHours.Period.OpenClose.DayOfWeek;
import Layer2.API.MapAPI.model.PlaceDetails.Review.AspectRating.RatingType;
import Layer2.API.MapAPI.model.PriceLevel;
import Layer2.API.MapAPI.model.TravelMode;
